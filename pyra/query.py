...
def main():
    ...
    parser = argparse.ArgumentParser(
        "pyra-index",
        description="Whoosh text searcher",
    ...
    parser.add_argument("-c", "--content", help="Search content", action="store_true")
    parser.add_argument("-s", "--summary", help="Search summary", action="store_true")
    parser.add_argument("-k", "--keywords", help="Search keywords", action="store_true")
